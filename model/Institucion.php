...
class  Institucion extends Main
{
    ...
    function index($query , $p ) 
    {
		...
		FROM
		institucion
		INNER JOIN ubigeo ON ubigeo.Ubigeo= institucion.ubi_id
        WHERE  inst_cod LIKE :query OR inst_nombre LIKE :query OR inst_nro_escuela LIKE :query ORDER BY 1 DESC";
