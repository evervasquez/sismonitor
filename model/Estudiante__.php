...
class Estudiante extends Main
{
    function index($query , $p ) 
    {
        $sql = "SELECT
            ...
            WHERE estudiante.nombre LIKE :query OR institucion.inst_nombre LIKE :query OR estudiante.apellidos LIKE :query OR estudiante.estudiante_id = :id ORDER BY 1 DESC";
