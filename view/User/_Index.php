...
<div style="margin: 0 auto; width: 660px; margin-bottom: 10px;">
    <form action="" method="GET">
        ...
        <a href="index.php?controller=User&action=create" class="btn_other"> Nuevo </a>
    </form>
</div>
...
<table class="ui-widget ui-widget-content" style="width: 660px; margin: 0 auto; " >
    ...
    <tbody >
        ...
        <tr >
            ...
            <td >
                <a href="index.php?controller=User&action=edit&id=<?php  echo $value[0]; ?>" title="Editar"><img alt="" src="images/edit.png" /></a>
                <a href="index.php?controller=User&action=delete&id=<?php  echo $value[0]; ?>" title="Eliminar"><img alt="" src="images/delete.png" /></a>
            </td>            
        </tr>
        <?php  } ?>
    </tbody>
