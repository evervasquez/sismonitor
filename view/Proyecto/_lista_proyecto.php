...
<div class='ui-widget-header'>Proyectos Registrados</div>
<div id="frmtotal">
	<div id="msg" ></div>
	<form id="_frm" name="_frm" action="" method="GET">
		<input type="hidden" name="controller" value="Proyecto" />
        <input type="hidden" name="action" value="mostrar_proyecto" />
	...
	<table  table width="99%" style="border:1px solid #666; font-size:14px; margin-bottom:5px;" align="center">
		...
		<tr style="border-bottom:1px solid #666; background:#F0F0F0;">
			...
			<td align="center"><a href="javascript:devolver_proyecto('<?php  echo $val[0]; ?>','<?php  echo $val[1]; ?>');" title="devolver"><img src="images/add.png"  border="0"></a></td>
		</tr>
			<?php }?>
	</table>
	<?php echo $pag;?>
