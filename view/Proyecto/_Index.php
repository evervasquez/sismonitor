...
<div class="contain"  >
<h4 class="ui-widget-header" >Buscar Proyecto</h4>
<form action="" method="GET">
    ...
    <a href="index.php?controller=Proyecto&action=create" class="links"> Nuevo </a>
</form>
<table class="ui-widget ui-widget-content" style="width: 660px; margin-top: 1px; margin-left: 3px; " >
    ...
    <tbody >
        ...
        <tr>
            ...
            <td ><a href="index.php?controller=Proyecto&action=edit&id=<?php  echo $value[0]; ?>" title="Editar"><img alt="" src="images/edit.png" /></a></td>
            <td ><a href="index.php?controller=Proyecto&action=delete&id=<?php  echo $value[0]; ?>" title="Borrar"><img alt="" src="images/delete.png" /></a></td>
        </tr>
        <?php  } ?>
    </tbody>
</table>
