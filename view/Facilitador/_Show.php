    ...
    <table border="0" >
        <tbody>
            ...
            <tr>
                <td>&nbsp;</td>
                <td>
                    <input type="submit" value="Eliminar" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-hover" />
                    <a href="index.php?controller=TipoPregunta" class="btn_other" > Cancelar </a>
                </td>
            </tr>
        </tbody>
    </table>
