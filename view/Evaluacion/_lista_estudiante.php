...
<div class='ui-widget-header'>Estudiantes Registrados</div>
<div id="frmtotal">
	<div id="msg" ></div>
	<form id="_frm" name="_frm" action="" method="GET">
		<input type="hidden" name="controller" value="Evaluacion" />
        <input type="hidden" name="action" value="mostrar_estudiante" />
	...
	<table  table width="99%" style="border:1px solid #666; font-size:14px; margin-bottom:5px;" align="center">
		<thead>
                    ...
                    <th align='left' class='ui-widget-header'>ESTUDIANTE</th>
                    <th align='left' class='ui-widget-header'>INST. EDUCATIVA</th>
		...
		<tr style="border-bottom:1px solid #666; background:#F0F0F0;">
			...
			<td align="center"><a href="javascript:devolver_estudiante('<?php  echo $val[0]; ?>','<?php  echo $val[1]; ?>','<?php  echo $val[2]; ?>','<?php  echo $val[3]; ?>');" title="devolver"><img src="images/add.png"  border="0"></a></td>
		</tr>
			<?php }?>
	</table>
	<?php echo $pag;?>
