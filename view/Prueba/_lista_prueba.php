...
<div class='ui-widget-header'>Pruebas Registradas</div>
<div id="frmtotal">
	<div id="msg" ></div>
	...
	<table  table width="99%" style="border:1px solid #666; font-size:14px; margin-bottom:5px;" align="center">
		<thead>
                    ...
                    <th align='left' class='ui-widget-header'>Area</th>
		...
		<tr style="border-bottom:1px solid #666; background:#F0F0F0;">
			...
			<td align="center"><a href="javascript:devolver_prueba('<?php  echo $val[0]; ?>','<?php  echo $val[1]; ?>','<?php  echo $val[2]; ?>');" title="devolver"><img src="images/add.png"  border="0"></a></td>
		</tr>
			<?php }?>
	</table>
	<?php echo $pag;?>
