...
<h6 class="ui-widget-header">Perfiles Registrados</h6>
<div class="contain">
<div style="margin: 0 auto; width: 660px; margin-bottom: 10px;">
    <form action="" method="GET">
        ...
        <a href="index.php?controller=Perfil&action=create" class="btn_other"> Nuevo </a>
    </form>
</div>
    ...
    <tbody >
        ...
        <tr >
            ...
            <td ><?php  echo $value[1]; ?></td>
             <td><?php
                    if($value[2]=="1"){echo "ACTIVO";}
                        else {echo "INACTIVO";}
                ?>
            </td>
            <td ><a href="index.php?controller=Perfil&action=edit&id=<?php  echo $value[0]; ?>" title="Editar"><img alt="" src="images/edit.png" /></a></td>
            <td ><a href="index.php?controller=Perfil&action=show&id=<?php  echo $value[0]; ?>" title="Ver"><img alt="" src="images/view.png" /></a></td>
        </tr>
        <?php  } ?>
    </tbody>
</table>
