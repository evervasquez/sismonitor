$(document).ready(function(){
    $("#cr007500,#cr007600,#cr007700,#cr008101,#cr008102,#cr008600,#cr008001,#cr008002,#cr008700,#cr008800,#cr008901,#cr008902,#cr009002").buttonset();
    $("#cr009001,#cr009600,#cr009800,#cr010101,#cr010102,#cr010201,#cr010202,#cr010700,#cr011101,#cr011102,#cr011201,#cr014300,#cr014500").buttonset();
    ...
    //
    $("#cc007800,#cc008200,#cc008300,#cc008400,#cc008500").buttonset();
    //
    $("#cc009100,#cc009200,#cc009300,#cc009400").buttonset();
    
    $("#cc010300,#cc010400,#cc010500,#cc010600").buttonset();
    
    $("#cc011300,#cc011400,#cc011500,#cc011600").buttonset();
    ...
    $("#013903").change(function(){if($(this).val()>59 || $(this).val()<0){msg("Valor incorrecto para los minutos. (De 00 a 59)");$(this).attr("value","00");}});
      ...
      /*
       * EVENTOS PARA LA PARTE DE VICTIMAS DE ROBO DE VIVIENDA
      */     
    $('input[name|="007500"]').click(function(){
                   valor = $("input[name='007500']:checked").val();                   
                  if(valor!=1){$("#cpreg007600").hide("slow");}
                    else {
                        $("#cpreg007600").show("slow");
      ...
      $('input[name|="007700"]').click(function(){
        ...
        $("#l008000").toggle(function(){
            $(this).fadeOut(function(){
                ...
                $('input[name=008001]:radio').resetbuttonset('#cr008001');
                $('input[name=008002]:radio').resetbuttonset('#cr008002');
                
                $('input[name=008101]:radio').resetbuttonset('#cr008101');
                $('input[name=008102]:radio').resetbuttonset('#cr008102');
                
                $("#t008000,#cpreg008100,#op008001,#op008002,#cpreg008200,#cpreg008300,#cpreg008400").hide("slow");
                
                $('#cc008200').resetbuttonset_check();
                $('#cc008300').resetbuttonset_check();
                $('#cc008400').resetbuttonset_check();
            ...
            $(this).fadeOut(function(){
             ...
             $("#t008000,#cpreg008100,#op008001,#op008002,#cpreg008400").show("slow");
        });
      
   
      
      $('input[name|="008001"]').click(function(){                
                   valor = $("input[name='008001']:checked").val();
                  if(valor!=1){$("#op008101,#cpreg008200").hide("slow");
                               $('input[name=008101]:radio').resetbuttonset('#cr008101');
                                $('#cc008200').resetbuttonset_check();
                                }
                    else {$("#op008101").show("slow");}
                });
       $('input[name|="008002"]').click(function(){                
                   valor = $("input[name='008002']:checked").val();
                  if(valor!=1){$("#op008102,#cpreg008200").hide("slow");
                            $('input[name=008102]:radio').resetbuttonset('#cr008102');
                            $('#cc008300').resetbuttonset_check();
                        }
                    else {$("#op008102").show("slow");}
                });
      
      $('input[name|="008101"]').click(function(){                
                   valor = $("input[name='008101']:checked").val();
                  if(valor==1){$("#cpreg008200").hide("slow");
                        $('#cc008200').resetbuttonset_check();
                }
      ...
      $('input[name|="008102"]').click(function(){
                  ...
                  if(valor==1){$("#cpreg008300").hide("slow");
                      $('#cc008300').resetbuttonset_check();
      ...
      /*
       * EVENTOS PARA LA PARTE DE TENTATIVA DE ROBO DE VIVIENDA
      */
      
      
       $("#l008900").toggle(function(){
            $(this).fadeOut(function(){
                $(this).empty().append("Click aqui si es que SI se denunció");
                $(this).removeClass("link-no");
                $(this).addClass("link-si");
                ...
                $('input[name=008901]:radio').resetbuttonset('#cr008901');
                $('input[name=008902]:radio').resetbuttonset('#cr008902');
                
                $('input[name=009001]:radio').resetbuttonset('#cr009001');
                $('input[name=009002]:radio').resetbuttonset('#cr009002');
                
                $("#t008900,#cpreg009000,#op009001,#op009002,#cpreg009100,#cpreg009200,#cpreg009300").hide("slow");
            ...
            $(this).fadeOut(function(){
             ...
             $("#t008900,#cpreg009000,#op009001,#op009002").show("slow");
        });
      
       $('input[name|="008901"]').click(function(){                
                   valor = $("input[name='008901']:checked").val();
                  if(valor!=1){$("#op009001,#cpreg009100").hide("slow");
                               $('input[name=009001]:radio').resetbuttonset('#cr009001');
                                $('#cc009100').resetbuttonset_check();
                                }
                    else {$("#op009001").show("slow");}
                });
       $('input[name|="008902"]').click(function(){                
                   valor = $("input[name='008902']:checked").val();
                  if(valor!=1){$("#op009002,#cpreg009200").hide("slow");
                            $('input[name=009002]:radio').resetbuttonset('#cr009002');
                            $('#cc009200').resetbuttonset_check();
                        }
                    else {$("#op009002").show("slow");}
                });
      
      $('input[name|="009001"]').click(function(){                
                   valor = $("input[name='009001']:checked").val();
                  if(valor==1){$("#cpreg009100").hide("slow");}
                    else {$("#cpreg009100").show("slow");}
                });
      $('input[name|="009002"]').click(function(){
                   valor = $("input[name='009002']:checked").val();
                  if(valor==1){$("#cpreg009200").hide("slow");}
                    else {$("#cpreg009200").show("slow");}
                });
                
         /*
          *     EVENTOS PARA VICTIMAS DE ROBO AUTOMOTOR
         */
      $('#009700').change(function(){
       ...
       $("#l010100").toggle(function(){
            $(this).fadeOut(function(){
                ...
                $('input[name=010101]:radio').resetbuttonset('#cr010101');
                $('input[name=010102]:radio').resetbuttonset('#cr010102');
                
                $('input[name=010201]:radio').resetbuttonset('#cr010201');
                $('input[name=010202]:radio').resetbuttonset('#cr010202');
                
                $("#t010100,#cpreg010200,#op010101,#op010102,#cpreg010300,#cpreg010400,#cpreg010500").hide("slow");
                
                $('#cc010300').resetbuttonset_check();
                $('#cc010400').resetbuttonset_check();
                $('#cc010500').resetbuttonset_check();
            ...
            $(this).fadeOut(function(){
             ...
             $("#t010100,#cpreg010200,#op010101,#op010102,#cpreg010500").show("slow");
        });
      
      $('input[name|="010101"]').click(function(){                
                   valor = $("input[name='010101']:checked").val();
                  if(valor!=1){$("#op010201").hide("slow");
                               $('input[name=010201]:radio').resetbuttonset('#cr010201');
                                $('#cc010300').resetbuttonset_check();
                                }
                    else {$("#op010201").show("slow");}
                });
       $('input[name|="010102"]').click(function(){                
                   valor = $("input[name='010102']:checked").val();
                  if(valor!=1){$("#op010202").hide("slow");
                            $('input[name=010202]:radio').resetbuttonset('#cr010202');
                            $('#cc010400').resetbuttonset_check();
                        }
                    else {
      ...
      $('input[name|="010201"]').click(function(){
                  ...
                  if(valor==1){$("#cpreg010300").hide("slow");
                                 $('#cc010300').resetbuttonset_check();}
                    else {$("#cpreg010300").show("slow");}
                });
      $('input[name|="010202"]').click(function(){
                   valor = $("input[name='010202']:checked").val();
                  if(valor==1){$("#cpreg010400").hide("slow");
                  $('#cc010400').resetbuttonset_check();}
                    else {$("#cpreg010400").show("slow");}
                });
                
      /*
       *    VICTIMAS DE ROBO DE OBJETOS EN VEHICULO AUTOMOTOR
      */
                      
      $('#010800').change(function(){
                   valor = $(this).val();
                  if(valor==1 || valor==2 || valor == 3 || valor == 4){$("#cpreg011000").show("slow"); $("#cpreg011100,#cpreg011200,#cpreg011500,#cpreg011600").show("slow");}
       ...
       $("#l011100").toggle(function(){
            $(this).fadeOut(function(){
                $(this).empty().append("Click aqui si es que SI se denunció");
                $(this).removeClass("link-no");
                $(this).addClass("link-si");
                $(this).fadeIn();                
                $('input[name=011101]:radio').resetbuttonset('#cr011101');
                $('input[name=011102]:radio').resetbuttonset('#cr011102');                
                $('input[name=011201]:radio').resetbuttonset('#cr011201');
                $('input[name=011202]:radio').resetbuttonset('#cr011202');                
                $("#t011100,#cpreg011200,#op011101,#op011102,#cpreg011300,#cpreg011400,#cpreg011500").hide("slow");
                
                $('#cc011300').resetbuttonset_check();
                $('#cc011400').resetbuttonset_check();
                $('#cc011500').resetbuttonset_check();                
            });
        },function(){
            $(this).fadeOut(function(){
                $(this).empty().append("Click aqui si es que NO se denunció");
             ...
             $("#t011100,#cpreg011200,#op011101,#op011102,#cpreg011500").show("slow");
        });
      
      $('input[name|="011101"]').click(function(){                
                   valor = $("input[name='011101']:checked").val();
                  if(valor!=1){$("#op011201").hide("slow");
                               $('input[name=011201]:radio').resetbuttonset('#cr011201');
                                $('#cc011300').resetbuttonset_check();
                                }
                    else {$("#op011201").show("slow");}
                });
       $('input[name|="011102"]').click(function(){                
                   valor = $("input[name='011102']:checked").val();
                  if(valor!=1){$("#op011202").hide("slow");
                            $('input[name=011202]:radio').resetbuttonset('#cr011202');
                            $('#cc011400').resetbuttonset_check();
                        }
                    else {
       ...
       $('input[name|="011201"]').click(function(){
                  ...
                  if(valor==1){$("#cpreg011300").hide("slow");$("#cc011300").resetbuttonset_check();}
                    else {$("#cpreg011300").show("slow");}
                });
      $('input[name|="011202"]').click(function(){
                   valor = $("input[name='011202']:checked").val();
                  if(valor==1){$("#cpreg011400").hide("slow");$("#cc011400").resetbuttonset_check();}
                    else {$("#cpreg011400").show("slow");}
                });
                
        /*
         * EVENTOS PARA VICTIMAS DE ROBO DE MOTOCICLETA / MOTOTAXI
         */
                  ...
                  if(valor==6 || valor==7)
                    {
                       ...
                       $('input[name=012301]:radio').resetbuttonset('#cr012301');
                       $('input[name=012302]:radio').resetbuttonset('#cr012302');
                       $('input[name=012200]:radio').resetbuttonset('#cr012200');
                       $("#cpreg012200,#cpreg012300,#cpreg012400,#cpreg012500,#cpreg012600,#cpreg012700").hide("slow");
                       $("#cpreg012000").hide("slow");
                    }
                });
       
       $("#l012200").toggle(function(){
            $(this).fadeOut(function(){
                $(this).empty().append("Click aqui si es que SI se denunció");
                $(this).removeClass("link-no");
                $(this).addClass("link-si");
                $(this).fadeIn();                
                $('input[name=012201]:radio').resetbuttonset('#cr012201');
                $('input[name=012202]:radio').resetbuttonset('#cr012202');                
                $('input[name=012301]:radio').resetbuttonset('#cr012301');
                $('input[name=012302]:radio').resetbuttonset('#cr012302');                
                $("#t012200,#cpreg012300,#op012201,#op012202,#cpreg012400,#cpreg012500,#cpreg012600").hide("slow");
                
                $('#cc012400').resetbuttonset_check();
                $('#cc012500').resetbuttonset_check();
                $('#cc012600').resetbuttonset_check();                
            });
        },function(){
            $(this).fadeOut(function(){
                $(this).empty().append("Click aqui si es que NO se denunció");
             ...
             $("#t012200,#cpreg012300,#op012201,#op012202,#cpreg012600").show("slow");
        });
      
      $('input[name|="012201"]').click(function(){                
                   valor = $("input[name='012201']:checked").val();
                  if(valor!=1){$("#op012301").hide("slow");
                               $('input[name=012301]:radio').resetbuttonset('#cr012301');
                                $('#cc012400').resetbuttonset_check();
                                }
                    else {$("#op012301").show("slow");}
                });
       $('input[name|="012202"]').click(function(){                
                   valor = $("input[name='012202']:checked").val();
                  if(valor!=1){$("#op012302").hide("slow");
                            $('input[name=012302]:radio').resetbuttonset('#cr012302');
                            $('#cc012500').resetbuttonset_check();
                        }
                    else { $("#op012302").show("slow"); }
                });
       
        $('input[name|="012301"]').click(function(){
                   valor = $("input[name='012301']:checked").val();
                  if(valor==1){$("#cpreg012400").hide("slow");$("#cc012400").resetbuttonset_check();}
                    else {$("#cpreg012400").show("slow");}
                });
        $('input[name|="012302"]').click(function(){
                   valor = $("input[name='012302']:checked").val();
                  if(valor==1){$("#cpreg012500").hide("slow");$("#cc012500").resetbuttonset_check();}
