    ...
    $.ajax({
        ...
        success: function(data_){
            ...
            if(data_.result==true)
            {
                ...
                setValue_("#total",(esnulo(parseInt(data_.institucion.nro_madres)) + esnulo(parseInt(data_.institucion.nro_madres_d)) + esnulo(parseInt(data_.institucion.nro_padres)) + esnulo(parseInt(data_.institucion.nro_madres))));
