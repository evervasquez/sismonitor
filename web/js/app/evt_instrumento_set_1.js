...
//                    }
            ...
            for(var i in poblacion_estudiantil)
                {
                    ...
                    setValue_("#poblacion_"+pob.grado+"_3",(parseInt(pob.hombres)+ parseInt(pob.hombres_d)));
                    setValue_("#poblacion_"+pob.grado+"_4", pob.mujeres);
                    setValue_("#poblacion_"+pob.grado+"_5", pob.mujeres_d);
                    setValue_("#poblacion_"+pob.grado+"_6",(parseInt(pob.mujeres)+ parseInt(pob.mujeres_d)));
                    setValue_("#poblacion_"+pob.grado+"_7",(parseInt(pob.hombres)+ parseInt(pob.hombres_d)+parseInt(pob.mujeres)+ parseInt(pob.mujeres_d)));
                }
           ...
           for(var i in conei)
             ...
             setValue_("T5_9", data_.institucion.inst_pat);
            ...
            for(var i in personal)
            {
                ...
                var ide_= parseInt(i)+1;
                    ...
                    setValue_("personal_"+ide_+"_3", pers.pers_experiencia_director);
                    setValue_("personal_"+ide_+"_4", pers.pers_experiencia_docente);
                    setValue_("personal_"+ide_+"_5", pers.pers_experiencia_escuela);
                    setValue_("personal_"+ide_+"_6", pers.pers_experiencia_proyecto);
